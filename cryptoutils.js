...
function hashPassword(password, callback) {
  ...
  crypto.randomBytes(config.saltBytes, function(err, salt) {
    ...
    crypto.pbkdf2(password, salt, config.iterations, config.hashBytes,null,
      function(err, hash) {
...
function verifyPassword(password, combined, callback) {
  ...
  crypto.pbkdf2(password, salt, iterations, hashBytes, null, function(err, verify) {
    if (err) {
      return callback(err, false);
    }
    console.log("en cripto utilidades");
    console.log(hash);
